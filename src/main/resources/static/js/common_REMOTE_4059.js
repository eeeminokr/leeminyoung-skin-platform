...
*/
    ...
    // if (sessionStorage.getItem("check_step_common") == null) {
    //     sessionStorage.setItem("check_step_common", "done");
    //     sessionStorage.setItem("contextpath", "${pageContext.request.contextPath}");
        
    //     if (!window.location.pathname.includes('solution_01_2')) {
    //         for (let i = 0; i < sessionStorage.length; i++) {
    //             let key = sessionStorage.key(i);
    //             if (key.includes('check_step')) {
    //                 sessionStorage.removeItem(key);
    //             }
    //         }
    //     }
    // } else if (window.location.pathname.includes('solution_01_2')) {
    //     sessionStorage.removeItem("check_step_common");
    // } else {
    //     for (let i = 0; i < sessionStorage.length; i++) {
    //         let key = sessionStorage.key(i);
    //         if (key.includes('check_step')) {
