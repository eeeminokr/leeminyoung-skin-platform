            ...
            <div class="lnb">
                ...
                <ul>
                    <li class="active"><a href="${pageContext.request.contextPath}/service/service_01_1">스마트미러</a>
                        <ul>
                            <li><a href="${pageContext.request.contextPath}/service/service_01_1">스마트미러&amp;피부진단 시스템</a></li>
                            <li  class="active"><a href="${pageContext.request.contextPath}/service/service_01_2">맞춤형화장품 플래그십 스토어</a></li>
                        </ul>
                    </li>
    ...
    <!-- //타이틀 -->
        ...
        <div class="content factory">
            <div class="inner">
                ...
                <h2 class="ff_nm bar">맞춤형화장품 플래그십 스토어</h2>
