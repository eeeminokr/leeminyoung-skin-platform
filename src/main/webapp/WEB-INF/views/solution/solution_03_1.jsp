...
<section class="container">
            ...
            <div class="lnb">
                ...
                <ul>
                    ...
                    <li class="active"><a href="${pageContext.request.contextPath}/solution/solution_03_1">AI기반 피부진단</a>
                        <ul>
                            <li class="active"><a href="${pageContext.request.contextPath}/solution/solution_03_1">AI기반 피부진단 개요</a></li>
                            <li><a href="${pageContext.request.contextPath}/solution/solution_03_2">AI기반 피부진단</a></li>
                        </ul>
                    </li>
    ...
    <!-- 컨텐츠 -->
    <div class="content ai_intro">
        <div class="inner">

            <h2 class="ff_nm bar">AI기반 피부진단 개요</h2>
