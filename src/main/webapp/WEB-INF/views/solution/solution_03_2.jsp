...
<body class="page_solution">
 ...
 <section class="container">
    ...
    <div class="lnb_wrap">
        <div class="inner">
            <div class="lnb">
                <button type="button">AI기반 피부진단</button>
                <ul>
                    ...
                    <li class="active"><a href="${pageContext.request.contextPath}/solution/solution_03_1">AI기반 피부진단</a>
                        <ul>
                            <li><a href="${pageContext.request.contextPath}/solution/solution_03_1">AI기반 피부진단 개요</a></li>
                            <li class="active"><a href="${pageContext.request.contextPath}/solution/solution_03_2">AI기반 피부진단</a></li>
                        </ul>
                    </li>
    ...
    <!-- 컨텐츠 -->
    <div class="content ai_diagnosis">
        <div class="inner">

            <h2 class="ff_nm bar">AI기반 피부진단</h2>
