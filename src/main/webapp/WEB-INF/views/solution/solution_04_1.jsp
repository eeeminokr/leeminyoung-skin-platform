...
<body class="page_solution">
 ...
 <section class="container">
            ...
            <div class="lnb">
                ...
                <ul>
                    ...
                    <li class="active"><a href="${pageContext.request.contextPath}/solution/solution_04_1">진단이력관리</a>
                        <ul>
                            <!-- <li class="active"><a href="${pageContext.request.contextPath}/solution/solution_04_1">바우만 테스트 이력관리</a></li> -->
    ...
    <!-- 컨텐츠 -->
    <div class="content mgtest">
        <div class="inner">

            <h2 class="ff_nm bar">바우만 테스트 이력관리</h2>
