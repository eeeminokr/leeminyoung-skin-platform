            ...
            <div class="inner">
                <div class="lnb">
                    ...
                    <ul>
                        ...
                        <li><a href="${pageContext.request.contextPath}/solution/solution_03_1">SkinLink</a></li>
                        <li><a href="${pageContext.request.contextPath}/solution/solution_04_1">AI기반 피부진단</a></li>
                        <li><a class="last" href="${pageContext.request.contextPath}/solution/solution_04_2">진단이력관리</a></li>
                    </ul>
                </div>
        ...
        <div class="content self">
            ...
            <div class="self_result type_oily">
                <div class="inner">
                    ...
                    <p class="txt">단점보다 장점이 많고 관리하기 쉬운 메추리알 피부</p>
                    <ul>
                        <li>
                        ...
                        <li>
                            ...
                            <p>번들거림, 어둡고 칙칙한 피부 톤</p>
                        </li>
                        <li>
                            <span class="txt">solution</span>
                            <p>SPF 301 이상의 자외선 차단제, 브라이트닝 필링</p>
                        </li>
                    </ul>
