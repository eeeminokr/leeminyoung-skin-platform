        ...
        <div class="content self">
            ...
            <div class="self_result type_dry">
                <div class="inner">
                    ...
                    <p class="txt">영원히 고통받는 총체적 난국 건성 민감 피부</p>
                    <ul>
                        <li>
                            <span class="txt">Weakness</span>
                            <p>피부가 매우 민감하고 않아 자극에 쉽게 반응. <br />
                                주름이 생기기 쉬움, 모든 종류의 문제를 보일 수 있는 피부</p>
                        </li>
                        <li>
                            <span class="txt">solution</span>
                            <p>반드시 민감성 제품만 사용, 패치테스트 필수. <br />
                                전문가에 의한 엄격한 피부 관리 필요</p>
                        </li>
                    </ul>
