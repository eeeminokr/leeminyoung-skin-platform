...
<body class="page_community">
 ...
 <section class="container">
        ...
        <div class="inner">
            <div class="lnb">
                ...
                <ul>
                    ...
                    <li class="active"><a href="${pageContext.request.contextPath}/community/community_03_1">맞춤형화장품 조제관리사 <br />Network</a>
                        <ul>
                            <li class="active"><a href="${pageContext.request.contextPath}/community/community_03_1">전용게시판</a></li>
                            <li><a href="${pageContext.request.contextPath}/community/community_03_2">컨텐츠 기획 중</a></li>
                        </ul>
                    </li>
    ...
    <!-- 컨텐츠 -->
    <div class="content network_board">

        <div class="inner">

            <h2 class="ff_nm bar">전용게시판</h2>
