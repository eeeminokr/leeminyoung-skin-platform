...
<body class="page_community">
 ...
 <section class="container">
            ...
            <div class="lnb">
                ...
                <ul>
                    ...
                    <li class="active"><a href="${pageContext.request.contextPath}/community/community_02_1">자료실</a>
                        <ul>
                            <li><a href="${pageContext.request.contextPath}/community/community_02_1">동영상 자료</a></li>
                            <li class="active"><a href="${pageContext.request.contextPath}/community/community_02_2">기타자료실</a></li>
                        </ul>
                    </li>
    ...
    <!-- 컨텐츠 -->
    <div class="content data_etc">

        <div class="inner">

            <h2 class="ff_nm bar">기타자료실</h2>
