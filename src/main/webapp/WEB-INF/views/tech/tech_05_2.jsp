...
<body class="page_tech">
    ...
    <section class="container">
        ...
        <div class="lnb_wrap">
            <div class="inner">
                <div class="lnb">
                    <button type="button">링커버스</button>
                    <ul>
                        ...
                        <li class="active"><a href="${pageContext.request.contextPath}/beautytech/tech_05_1">링커버스</a>
                            <ul>
                                <li><a href="${pageContext.request.contextPath}/beautytech/tech_05_1">회사소개</a></li>
                                <li class="active"><a href="${pageContext.request.contextPath}/beautytech/tech_05_2">피부진단기 모델</a></li>
                            </ul>
                        </li>
