...
<body class="page_tech">
    ...
    <section class="container">
        ...
        <div class="lnb_wrap">
            <div class="inner">
                <div class="lnb">
                    <button type="button">케이씨테크놀러지</button>
                    <ul>
                        ...
                        <li class="active"><a href="${pageContext.request.contextPath}/beautytech/tech_07_1">케이씨테크놀러지</a>
                            <ul>
                                <li><a href="${pageContext.request.contextPath}/beautytech/tech_07_1">회사소개</a></li>
                                <li class="active"><a href="${pageContext.request.contextPath}/beautytech/tech_07_2">피부진단기 모델</a></li>
                            </ul>
                        </li>
                ...
                <ul class="depth_03">
                    <li><a href="${pageContext.request.contextPath}/tech/tech_07_1">회사소개</a></li>
                    <li class="active"><a href="${pageContext.request.contextPath}/tech/tech_07_2">피부진단기 모델</a></li>
                </ul>
            </div>
        </div>
        <!-- //컨텐츠 상단 서브 메뉴 -->
