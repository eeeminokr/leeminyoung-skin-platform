                ...
                <div class="lnb">
                    ...
                    <ul>
                        ...
                        <li class="active"><a href="${pageContext.request.contextPath}/beautytech/tech_03_1">룰루랩</a>
                            <ul>
                                <li class="active"><a href="${pageContext.request.contextPath}/beautytech/tech_03_1">회사소개</a></li>
                                <li><a href="${pageContext.request.contextPath}/beautytech/tech_03_2">피부진단기 모델</a></li>
                            </ul>
                        </li>
