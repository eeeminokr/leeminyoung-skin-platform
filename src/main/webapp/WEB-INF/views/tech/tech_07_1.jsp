                ...
                <div class="lnb">
                    ...
                    <ul>
                        ...
                        <li class="active"><a href="${pageContext.request.contextPath}/beautytech/tech_07_1">케이씨테크놀러지</a>
                            <ul>
                                <li class="active"><a href="${pageContext.request.contextPath}/beautytech/tech_07_1">회사소개</a></li>
                                <li><a href="${pageContext.request.contextPath}/beautytech/tech_07_2">피부진단기 모델</a></li>
                            </ul>
                        </li>
