                ...
                <div class="lnb">
                    ...
                    <ul>
                        <li class="active"><a href="${pageContext.request.contextPath}/beautytech/tech_01_1">아람휴비스</a>
                            <ul>
                                <li><a href="${pageContext.request.contextPath}/beautytech/tech_01_1">회사소개</a></li>
                                <li class="active"><a href="${pageContext.request.contextPath}/beautytech/tech_01_2">피부진단기 모델</a></li>
                            </ul>
                        </li>
