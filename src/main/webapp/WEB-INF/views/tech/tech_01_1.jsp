...
<body class="page_tech">
    ...
    <section class="container">
        ...
        <div class="lnb_wrap">
            <div class="inner">
                <div class="lnb">
                    <button type="button">아람휴비스</button>
                    <ul>
                        <li class="active"><a href="${pageContext.request.contextPath}/beautytech/tech_01_1">아람휴비스</a>
                            <ul>
                                <li class="active"><a href="${pageContext.request.contextPath}/beautytech/tech_01_1">회사소개</a></li>
                                <li><a href="${pageContext.request.contextPath}/beautytech/tech_01_2">피부진단기 모델</a></li>
                            </ul>
                        </li>
                        ...
                        <li><a class="last" href="${pageContext.request.contextPath}/beautytech/tech_08_1">인바디</a></li>
                    </ul>
                </div>
